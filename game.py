...
class TicTacToe():
    ...
    def winner(self,square,letter):
        # winner if 3 in a row anywhere...we have to check 
        # whether its in a row,column or diagonal
        ...
        # check diagonals
        # Diagonals are possible only if the square is an even number (0,2,4,6,8)
        if square % 2 == 0 :
